class Food:
    class NutritionsCalculator:
        ...
        def check_BMI(self):
            if self.BMI() < 18.5:
                print(f"Your BMI is {self.BMI()}\nUnderweight. Gain weight to reach 21.7 BMI.")
                self.gain_perfect_weight()
            elif 18.5 <= self.BMI() < 21.7 or 21.7 <= self.BMI() < 24.9:
                print("Healthy weight. Perfect BMI!")
            elif 25 < self.BMI() < 29.9:
                print(f"Your BMI is {self.BMI()}. Overweight. Aim for 21.7 BMI.")
                self.gain_perfect_weight()
            else:
                print("Obese. Aim for 21.7 BMI.")
                self.gain_perfect_weight()
        ...
        def gain_perfect_weight(self):
            ...
            if self.gender.lower() in gender_prefix:
                ...
                info_lines = [
                    f"{prefix} you need to maintain BMI of 21.7",
...
def main():
    def get_user_height():
        ...
        if unit_choice == "cm":
            ...
            total_height_cm = (feet * 30.48) + (inches * 2.54)
    ...
    def activity_level():
        al = {
            ...
            "lightly_active-->Light exercise": 1.375,
            "moderate-->Moderate exercise": 1.55,
            "very_active-->Heavy exercise": 1.725,
            "extra_active-->Very heavy exercise": 1.9
        }
    ...
    def climate_factor():
        cf = {"Hot and Humid climate":1.2, "Moderate Climate":1.2, "Cold and dry Climate":0.8}
        print("Choose a climate factor:")
    ...
    for i in range(members):
        ...
        cf = climate_factor()
        obj = Food()
        obj = obj.NutritionsCalculator(name, age, gender, height, weight, af, cf)
        obj.print_info()
